...
export default class SearchBar extends Component {
  ...
  onSubmitHandler(event) {
    ...
    const formattedPrice = this.formatPrice(this.state.priceLow, this.state.priceHigh);
    ...
    return (
      <div className="input-form">
        <form onSubmit={e => this.onSubmitHandler(e)}>
          <input className="input" type="text" name="location" value={this.state.location} placeholder={this.state.placeHolder} onChange={e => this.onChangeHandler(e)} />
          {navigator.geolocation ? <button className="button" onClick={e => this.onClickHandler(e)}>or Use Current Location</button> : null}
          <input className="input" id="term" type="text" name="term" value={this.state.term} placeholder="What are you looking for?" onChange={e => this.onChangeHandler(e)} />
          <p>rounds:</p>
